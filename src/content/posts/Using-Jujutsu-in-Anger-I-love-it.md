...
To push bookmarks to github, run jj git push --bookmark \<bookmark\_name> . If it’s a new bookmark, append --allow-new to the end.

### Implementing feedback

If you get feedback on a PR, you can go straight to the change and address it. Run jj edit \<change\_id> and you'll be right back where you were. Make your changes, then run jj git push.
